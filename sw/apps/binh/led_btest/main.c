...
int main()
{
    ...
    while(1) {
        set_gpio_pin_value( 8, get_gpio_pin_value( 16));
        set_gpio_pin_value( 9, get_gpio_pin_value( 17));
        set_gpio_pin_value(10, get_gpio_pin_value( 18));
        set_gpio_pin_value(11, get_gpio_pin_value( 19));
        set_gpio_pin_value(12, get_gpio_pin_value( 20));

...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y11 [get_ports ext_tdi_i]
set_property PACKAGE_PIN AA11 [get_ports ext_tms_i]
set_property PACKAGE_PIN Y10 [get_ports ext_tck_i]
set_property PACKAGE_PIN AA9 [get_ports ext_tdo_o]
set_property PACKAGE_PIN AB11 [get_ports ext_trstn_i]
...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN AB12 [get_ports oled_sclk_io]
set_property PACKAGE_PIN AA12 [get_ports oled_sdin_io]
set_property PACKAGE_PIN U10 [get_ports oled_dc_o]
set_property PACKAGE_PIN U9 [get_ports oled_res_o]
set_property PACKAGE_PIN U11 [get_ports oled_vbat_o]
set_property PACKAGE_PIN U12 [get_ports oled_vdd_o]
...
# User LEDs - Bank 33
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN T22 [get_ports {LD_o[0]}]
set_property PACKAGE_PIN T21 [get_ports {LD_o[1]}]
set_property PACKAGE_PIN U22 [get_ports {LD_o[2]}]
set_property PACKAGE_PIN U21 [get_ports {LD_o[3]}]
set_property PACKAGE_PIN V22 [get_ports {LD_o[4]}]
set_property PACKAGE_PIN W22 [get_ports {LD_o[5]}]
set_property PACKAGE_PIN U19 [get_ports {LD_o[6]}]
set_property PACKAGE_PIN U14 [get_ports {LD_o[7]}]
...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN P16 [get_ports {btn_i[0]}]
set_property PACKAGE_PIN R16 [get_ports {btn_i[1]}]
set_property PACKAGE_PIN N15 [get_ports {btn_i[2]}]
set_property PACKAGE_PIN R18 [get_ports {btn_i[3]}]
set_property PACKAGE_PIN T18 [get_ports {btn_i[4]}]
